    ...
    (() => {
            ...
            window.addEventListener("load", (function(e) {
                ...
                function getHeight(showMoreBlock, showMoreContent) {
                    ...
                    if (showMoreType === "items") {
                        ...
                        const showMoreTypeValue = showMoreContent.dataset.showmoreContent ? showMoreContent.dataset.showmoreContent : 240;
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                new swiper_core_Swiper(".clients__slider", {
                    modules: [ Autoplay ],
                    centeredSlides: true,
                    speed: 3e3,
                    autoplay: {
        ...
        const languageBlock = () => {
            ...
            languageContainers.forEach((function(languageContainer) {
                let languageButton = languageContainer.querySelector(".language__button");
            ...
            document.addEventListener("click", (function(event) {
                languageContainers.forEach((function(languageContainer) {
                    if (!languageContainer.contains(event.target)) languageContainer.classList.remove("open");
                }));
            }));
        };
        const tabs = () => {
            document.addEventListener("DOMContentLoaded", (function() {
                const tabsNav = document.querySelector("[data-tabs-titles]");
                const tabsContents = document.querySelectorAll("[data-tabs-item]");
                tabsContents.forEach(((content, index) => {
                    if (index !== 0) content.hidden = true;
                }));
                tabsNav.addEventListener("click", (function(event) {
                    const clickedTitle = event.target.closest(".tabs__title");
                    if (clickedTitle) {
                        event.preventDefault();
                        const clickedIndex = Array.from(tabsNav.children).indexOf(clickedTitle);
                        tabsNav.querySelectorAll(".tabs__title").forEach((title => title.classList.remove("_tab-active")));
                        tabsContents.forEach((content => content.classList.remove("_tab-active")));
                        clickedTitle.classList.add("_tab-active");
                        tabsContents[clickedIndex].hidden = false;
                        setTimeout((() => {
                            tabsContents[clickedIndex].classList.add("_tab-active");
                        }), 100);
                        tabsContents.forEach(((content, index) => {
